# Coffeekraken s-i-typed-component <small>0.0.1</small> [![Build Status](https://travis-ci.org/Coffeekraken/s-i-typed-component.svg)](https://travis-ci.org/Coffeekraken/s-i-typed-component)
